...
wage_recipe <- recipe(
  log_hourly_wage ~ 
    ...
    region +  working_hours + university_treatment,
...
dml_data_prep <- earnings_data %>%
  select(
    ...
    university_treatment,    # Treatment variable (D)
    # Control variables (X)
    age,
    age_sq,
    gender,
...
ggplot(results_summary, aes(x = "University Effect")) +
